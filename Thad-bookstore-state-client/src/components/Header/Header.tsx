...
const Header = () => {
  ...
  const { cart } = useCart(); // Use the custom hook to get categories 
      ...
      <div className="container">
        <div className={styles.headerInner}>
          ...
          <div className={styles.header_cart}>
            ...
            <Link to="#" className={styles.link}><img src={`${import.meta.env.BASE_URL}/site-images/cart.svg`} />My Cart <b>$0.00</b> <b>{cart.numberOfItems}</b></Link>
          </div>
        </div>
      </div>
    </div>
